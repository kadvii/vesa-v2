        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VisaTypes_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisaTypeId = table.Column<Guid>(type: "uuid", nullable: false),
                    CountryId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    TravelDateFrom = table.Column<DateOnly>(type: "date", nullable: false),
                    TravelDateTo = table.Column<DateOnly>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VisaApplications_AspNetUsers_ApplicantId",
                        column: x => x.ApplicantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VisaApplications_AspNetUsers_ReviewedByAdminId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VisaApplications_VisaTypes_VisaTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisaApplications_ReviewedByAdminId",
                table: "VisaApplications",
                column: "ReviewedByAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_VisaApplications_VisaTypeId",
                table: "VisaApplications",
                column: "VisaTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_VisaTypes_CountryId",
                table: "VisaTypes",
                column: "CountryId");
        }
